...
# Aim: Finetune the MLP and LLM after quantizing the model
...
epoch=1
lr=2e-5
output_dir=$llava_med_dir/checkpoints/lora-${model_name}-${data_file}-train-mlp-and-llm-quantized-${bits}-epoch-${epoch}-lr-${lr}
##############################################################
